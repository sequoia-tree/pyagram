...
export const PG_DATA_ERROR_PANEL_ID = 'error-panel';
...
export const EXCEPTION_VIEW_ID = 'exception-banner';
...
export const PG_DATA_ERROR_PANEL = document.getElementById(PG_DATA_ERROR_PANEL_ID);
