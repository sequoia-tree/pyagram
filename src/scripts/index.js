...
const EDITOR_ID = 'editor-pyagram-code';
const SLIDER_ID = 'slider-snapshot-slider';
const SLIDER_LABEL_ID = 'slider-snapshot-slider-label';
const SLIDER_L_BUTTON_ID = 'slider-snapshot-slider-l';
const SLIDER_R_BUTTON_ID = 'slider-snapshot-slider-r';
const VIS_OPTIONS_TEXT_POINTERS_ID = 'options-visualization-options-option-text-pointers';
const VIS_OPTIONS_HIDE_FLAGS_ID = 'options-visualization-options-option-hide-flags';
const OUTPUT_OVERLAY_ID = 'overlay-output-overlay';
const DRAW_PYAGRAM_BUTTON_ID = 'button-draw-pyagram';
const PYAGRAM_STACK_HEAP_SWITCH_ID = 'switch-pyagram-stack-heap-switch';
const PYAGRAM_TRACK_UNIFIED_VIEW_ID = 'switch-pyagram-stack-heap-switch-track-unified-view';
const PYAGRAM_TRACK_DIVIDED_VIEW_ID = 'switch-pyagram-stack-heap-switch-track-divided-view';
